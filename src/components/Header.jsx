  ...
  return (
    <header className="relative">
      ...
      <div className="relative max-w-6xl px-4 pt-56 pb-5 mx-auto text-white 2xl:max-w-7xl">
        ...
        <div className="mt-10">
          <div className="grid max-w-3xl grid-cols-3 px-4 py-4 text-center text-white rounded-md shadow-md gap-y-2 lg:gap-y-0 lg:divide-x lg:px-0 lg:py-6 lg:grid-cols-5 bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 divide-white/20">
            <div className="block">
          ...
          <div className="inline-grid w-auto max-w-3xl grid-cols-2 px-4 py-4 mt-4 text-center text-white rounded-md shadow-md lg:hidden gap-y-2 lg:gap-y-0 lg:divide-x lg:px-0 lg:py-6 lg:grid-cols-5 bg-gradient-to-r from-blue-400 via-blue-500 to-blue-600 divide-white/20">
            <div>
              <p className="text-2xl font-semibold leading-none lg:text-3xl">
                $10B+
              </p>
